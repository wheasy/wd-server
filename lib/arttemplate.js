...
!(function() {
    ...
    var TRIMREGEX = /^\s+|\s+$/g;
    var trim = trim = String.prototype.trim ?
        function(s) {
        ...
        switch (key) {
            ...
            case 'var':
                ...
                for (var i = params.length - 1; i >= 0; i--) {
                    tempArray = trim(params[i]).split('=');
                    var_from.push(tempArray[1]);
                    var_to.push(tempArray[0]);
                }
                code = '$assem([' + var_from.join(',') + '],function(' + var_to.join(',') + '){';
                tempArray = null;
                break;
